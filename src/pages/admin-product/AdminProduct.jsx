      ...
      <div className="admin-container">
          ...
          <div className="form-container">  
            <form className="admin-form" onSubmit={handleSubmit(onProductSubmit)}>
              ...
              <div className="input-group">
                <label htmlFor="description">Descripción de card</label>
                <textarea {...register("description")} rows={5}></textarea>
              </div>

              <div className="input-group">
                <label htmlFor="descriptionp">Descripción </label>
                <textarea {...register("descriptionp")} rows={5}></textarea>
              </div>
              <div className="input-group">
              ...
              <div className="input-group">
                ...
                <div className="input-group">
                  ...
                  <input accept="image/*" type="fyle" {...register("image") } />
                </div>
